...
WHERE a.orderid='$alocateid' AND a.payq='$payq' AND DATE(a.orderdate)=CURDATE() AND `status`=0";

$limit="SELECT * FROM orderdoc WHERE orderid='$alocateid' AND payq='$payq' AND DATE(orderdate)=CURDATE() AND `status`=0 LIMIT 1";
