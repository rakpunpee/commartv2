...
<?php 
$sd= "SELECT s.brand,sum(o.price)as sumprice,count(o.orderid)as corder FROM orderdoc as o LEFT JOIN stock as s ON o.productid = s.productid 
WHERE o.status = 0 AND o.sucess=1 AND o.alocateid = 'JIB' AND DATE(o.orderdate) = '2018-06-24' GROUP BY s.brand";
$str=Yii::app()->db->createCommand($sd)->queryAll();

$sd2= "SELECT s.brand,sum(o.price)as sumprice,count(o.orderid)as corder FROM orderdoc as o LEFT JOIN stock as s ON o.productid = s.productid 
WHERE o.status = 0 AND o.sucess=1 AND o.alocateid = 'JIB' AND DATE(o.orderdate) = '2018-06-23' GROUP BY s.brand";
$str2=Yii::app()->db->createCommand($sd2)->queryAll();

$sd3= "SELECT s.brand,sum(o.price)as sumprice,count(o.orderid)as corder FROM orderdoc as o LEFT JOIN stock as s ON o.productid = s.productid 
WHERE o.status = 0 AND o.sucess=1 AND o.alocateid = 'JIB' AND DATE(o.orderdate) = '2018-06-22' GROUP BY s.brand";
$str3=Yii::app()->db->createCommand($sd3)->queryAll();

$sd4= "SELECT s.brand,sum(o.price)as sumprice,count(o.orderid)as corder FROM orderdoc as o LEFT JOIN stock as s ON o.productid = s.productid 
WHERE o.status = 0 AND o.sucess=1 AND o.alocateid = 'JIB' AND DATE(o.orderdate) = '2018-06-21' GROUP BY s.brand";
