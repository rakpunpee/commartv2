...
<?php 
$sd= "SELECT o.boots as shop,sum(o.price)as sumprice,count(o.orderid)as corder FROM orderdoc as o WHERE o.status = 0 AND o.sucess=1 AND o.alocateid = 'JIB' AND DATE(o.orderdate) = '2018-06-24' GROUP BY o.boots";
$str=Yii::app()->db->createCommand($sd)->queryAll();

$sd2= "SELECT o.boots as shop,sum(o.price)as sumprice,count(o.orderid)as corder FROM orderdoc as o WHERE o.status = 0 AND o.sucess=1 AND o.alocateid = 'JIB' AND DATE(o.orderdate) = '2018-06-23' GROUP BY o.boots";
$str2=Yii::app()->db->createCommand($sd2)->queryAll();

$sd3= "SELECT o.boots as shop,sum(o.price)as sumprice,count(o.orderid)as corder FROM orderdoc as o WHERE o.status = 0 AND o.sucess=1 AND o.alocateid = 'JIB' AND DATE(o.orderdate) = '2018-06-22' GROUP BY o.boots";
$str3=Yii::app()->db->createCommand($sd3)->queryAll();

$sd4= "SELECT o.boots as shop,sum(o.price)as sumprice,count(o.orderid)as corder FROM orderdoc as o WHERE o.status = 0 AND o.sucess=1 AND o.alocateid = 'JIB' AND DATE(o.orderdate) = '2018-06-21' GROUP BY o.boots";
