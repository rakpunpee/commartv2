<script type="text/javascript">
  $(document).ready(function () {
    ...
    var getAdapter=function(){
     var source =
     {
      ...
      url: '<?php echo $this->createUrl("/cancelorder/Showsearch");?>',
      cache: false,
  ...
  return dataAdapter;
           ...
           { text: 'แก้ไข',editable:false, align: 'center' ,columntype: 'button',width: 80,filterable: false , cellsrenderer: function () {
             return "แก้ไข";
           }, buttonclick: function (row) {
             var datarow = $("#jqxgrid").jqxGrid('getrowdata', row);

             window.open("http://172.18.0.30/commartv02/index.php/cancelorder/editor2?orderid="+datarow.orderid
              ,"_blank","toolbar,scrollbars,resizable,top=0,left=0,width=700px,height=880px");

           }
         },
         { text: 'NO.',datafield: 'orderid',cellsalign: 'center',align: 'center',filterable: false,editable: true ,width: '5%',hidden: true},
        ...
        { text: 'modelid',datafield: 'modelid',align: 'center',cellsalign: 'center',filterable: true,  editable: true,width: '5%'},
              // { text: 'บัตรคิว',datafield: 'payq',align: 'center',cellsalign: 'center',filterable: true,editable: true,width: '5%'},
              ...
              { text: 'ประเภทการชำระ',datafield: 'paytype',align: 'center',cellsalign: 'center',filterable: true,editable: true,width: '5%'},
              { text: 'สถานะออเดอร์',datafield: 'status',align: 'center',cellsalign: 'center',filterable: true,editable: true,width: '7%'},
              { text: 'สถานะJOB',datafield: 'sucess',align: 'center',cellsalign: 'center',filterable: true,editable: true,cellclassname:colorstatus,width:70},
              ...
              if(conf==true  && access==1){
               ...
               window.open("http://172.18.0.30/commartv02/index.php/cancelorder/comment?id="+datarow.orderid+"&productid="+datarow.productid,"_blank","toolbar,scrollbars,resizable,top=0,left=0,width=480px,height=280px");
...
<div class="col-md-12">
  ...
  <div class="panel panel-primary">
    <div class="panel-heading"><h4 align="center"><b>รวมรายการRegisterทั้งหมด</b></h4></div>
