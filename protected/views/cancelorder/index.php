...
<script type="text/javascript">
  ...
  return dataAdapter;
        ...
        { text: 'modelid',datafield: 'modelid',align: 'center',cellsalign: 'center',filterable: true,  editable: true,width: '5%'},
          ...
          { text: 'ราคา',datafield: 'price',align: 'center',cellsalign: 'center',filterable: false,editable: true,cellsformat: 'n',width: '5%'},
           { text: 'บูธ',datafield: 'boots',align: 'center',cellsalign: 'center',filterable: true,editable: true,width: '10%'},
